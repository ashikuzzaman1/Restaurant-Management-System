...
<head>
	<meta charset="UTF-8">
	<title>Update Delivery Boys Information!</title>
</head>
...
<?php
	...
	if($_GET[ 'submit'])
	{
		...
		$query = "UPDATE deliveries SET username='$username' , email='$email' , contactno='$contactno' WHERE id='$id' ";
...
?>	
<a href="viewdeliveries.php">Check Update Here</a>
