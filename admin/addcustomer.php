...
<body style="background-color: coral;";>
	<form onsubmit="return validate()" action="addcusconfig.php" method="POST" enctype="multipart/form-data">
		ID:<br>
		<input type="text" name="id" value="" placeholder="Enter ID" required><br>
		Username:<br>
		<input type="text" id="username" name="username" value="" placeholder="Enter Username" ><br>
		Email:<br>
		<input type="email" name="email" value="" placeholder="Enter Email" required><br>
		Password:<br>
		...
		Address<br>
		<input type="text" name="address" value="" placeholder="Enter Address" required><br>
		Image:<br>
